            ...
            <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="mb-4">
                           Selamat Datang di Dashboar Admin Penyewaan Lapangan Futsal <span class="fw-bold">Scudetto Banyuwangi</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="d-block mb-1">Jumlah Pemesanan</span>
                        <h3 class="card-title text-nowrap mb-2">{{$pesanan}}</h3>
                    </div>
                </div>
            </div>
            <div class="col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-title mb-2">Rp. {{intval($saldo)}},-</h6>
                    </div>
                </div>
            </div>
        </div>
