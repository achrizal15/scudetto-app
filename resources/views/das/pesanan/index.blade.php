                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('terima',$item->id).'?status=SELESAI'}}"><i class="bx bx-check me-1"></i>
                                    Terima</a>
                                <a class="dropdown-item"  href="{{route('terima',$item->id).'?status=BATAL'}}"><i class="bx bx-x me-1"></i>
                                    Batalkan</a>
                            </div>
                        </div>
                    </td>
